...
import com.booking.DAO.CollectionGenerator;
...
public class ConsoleApp {
    ...
    private User userRegistration() {
        ...
        try {
            ...
            logger.info(user.getName() + " " + user.getSurname() + "new user was created");
            ...
            logger.error(user.getName() + " " + user.getSurname() + "user wasn't created");
            System.out.println(e.getMessage());
        }
        return user;
    }
